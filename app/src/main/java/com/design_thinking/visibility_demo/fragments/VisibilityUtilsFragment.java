package com.design_thinking.visibility_demo.fragments;
...
import com.design_thinking.visibility_demo.adapter.VisibilityUtilsAdapter;
...
public class VisibilityUtilsFragment extends Fragment implements VisibilityItem.ItemCallback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = root.findViewById(R.id.visibility_demo_recycler_view);
