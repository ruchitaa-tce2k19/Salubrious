...
import com.design_thinking.salubrious.NeedyClass.InformationAdapter;
       ...
       // ClickListener for floating action bar
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent intent = new Intent(com.design_thinking.salubrious.DairyActivity.this,AddDataActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(DairyActivity.this,UpdateActivity.class);
            ...
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                ...
                //if(menuItem.getItemId() == R.id.deleteContextMenuId){
                    for(String i : selectList){
                        ...
                        Intent intent = new Intent(DairyActivity.this, DairyActivity.class);
